...
public class RuoKuaiDaMaApi {
    ...
    private static  String username = "hyccservicecom";//用户名

    private static  String password = "HANGtian126";//密码
    ...
    private static  String softid = "32501";//打码软件ID

    private static  String softkey = "99b5b0f67d5a4abdbcbce11b021206cd";//打码软件密码

    //    private static final int TIMEOUT = 90000;//打码请求超时时间 毫秒
    private static final int TIMEOUT = 20000;//打码请求超时时间 毫秒
    public RuoKuaiDaMaApi(String username, String password, String typeid, String softid, String softkey) {
        super();
        RuoKuaiDaMaApi.username = username;
        RuoKuaiDaMaApi.password = password;
        RuoKuaiDaMaApi.typeid = typeid;
        RuoKuaiDaMaApi.softid = softid;
        RuoKuaiDaMaApi.softkey = softkey;
    }
     ...
     * @param imgPath
     * @return
     * @time 2016年5月5日 上午11:40:55
     * @author fiend
     */
    public static DaMaResult localPrint4Code(String imgPath) {
        return localPrint(imgPath, "3040");
    }

    //本地打码，imgPath格式如： D:\\image\\vcode.jpg
    public static DaMaResult localPrint(String imgPath, String _typeid) {
        //打码结果XML
        String xml = createByPost(username, password, _typeid, timeout, softid, softkey, imgPath);
        //解析XML
    ...
    //远程打码，imgUrl格式如：http://www.yeebooking.com/images/vcode.jpg
    public static DaMaResult remotePrint(String imgUrl, String typeid) {
        //打码结果XML
        String xml = createByUrl(username, password, typeid, timeout, softid, softkey, imgUrl);
        //解析XML
        DaMaResult result = displayXmlResult(xml);
